 ...
 * 6.) Die Kosten für den Deal werden nach fixen Formel berechnet: Für Strom: kwh * 0.10, Für Gas: m3 * 20 und die CUSTOM-Kosten werden menge*1.
 * Passe die Klasse Deals an. Ändere den Status des Deals auf Finished.
 ...
 * Optional.) Mache dich mit den ShortCuts des In
 * telliJ IDEs vertraut.
 *
 * */


fun main(){
    val factory = Basics.Assignment1.Classes.PersonFactory()
